          ...
          <div className="row">
            ...
            <div className="col-6 col-lg-3 offset-lg-1 mb-3">
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-2"><a href="/docs/5.2/">Services</a></li>
                <li className="mb-2"><a href="/docs/5.2/examples/">Blog</a></li>
                <li className="mb-2"><a href="https://themes.getbootstrap.com/">Contact</a></li>
              </ul>
            </div>
            <div className="col-6 col-lg-3 mb-3">
              <h5 className="mb-4">Service</h5>
              <ul className="list-unstyled">
                <li className="mb-2"><a href="/docs/5.2/getting-started/">Design</a></li>
                <li className="mb-2"><a href="/docs/5.2/examples/starter-template/">Devlopment</a></li>
                <li className="mb-2"><a href="/docs/5.2/getting-started/webpack/">Marketing</a></li>
                <li className="mb-2"><a href="/docs/5.2/getting-started/parcel/">See More</a></li>
              </ul>
            </div>
